...
/* ── Config ─────────────────────────────────────────────────── */
const CONFIG = {
  apiUrl:    'https://api.github.com/repos/Lanzkila/KirinDL/releases',
  cacheKey:  'kirindl_releases_cache',
...
async function loadReleases(forceRefresh = false) {
  ...
  try {
    ...
    console.error('[KirinDL] Releases fetch error:', err);
